...
View the tutorial video below for more information about terminology and hierarchy, or visit the [Glossary](/glossary/).
...
The search box provides the following features to the user:
