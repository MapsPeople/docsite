...
**Doors** are Route Elements that indicate the presence of a door - or other entryway - in a building. Here is an example of doors editor that shows up after we choose a door placement on the map:
