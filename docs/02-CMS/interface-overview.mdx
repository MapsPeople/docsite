...
**Doors** are Route Elements that indicate the presence of a door - or other entryway - in a building. Here is an example of doors editor that shows up after you choose a door placement on the map:
...
* snap to the middle point of the closest wall of the closest polygon to mouse pointer,
...
You can also undo latest door creation.
