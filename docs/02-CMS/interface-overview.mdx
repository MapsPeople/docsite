...
* will snap to the middle point of the polygon that mouse is intersecting with/over,
* will snap to the corners of the polygon that mouse is intersectiny with/over.
