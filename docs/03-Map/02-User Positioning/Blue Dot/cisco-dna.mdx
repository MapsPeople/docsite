...
<TabItem value="ios_v3" label="iOS v3">
...
<img src="/img/map/positioning-diagram.png" alt="The data flow of our sites to Google" width="600"/>
...
1. Make sure you have [integrated MapsIndoors](getting-started/ios) succesfully.
...
For a full implementation of this, please [see here](https://github.com/MapsPeople/MapsIndoorsSDK-iOS-Examples/tree/main/MapsIndoorsSDK-iOS-Examples/Advanced/Position%20Provider).
...
1. Make sure you have [integrated MapsIndoors](getting-started/ios) succesfully.
1. Download or close [this Swift file](https://github.com/MapsPeople/MapsIndoorsSDK-iOS-Examples/blob/main/MapsIndoorsSDK-iOS-Examples/Advanced/Position%20Provider/CiscoDNA/PureCiscoDNAProvider.swift) containing the CiscoDNA integration source.
1. Create a group in your Xcode project, e.g. called CiscoDNA.
1. Drag and drop the file in the downloaded folder to your new group. Choose "Copy items if needed".
1. In your app where you setup your position provider, add the following code:
...
1. Replace `my-cisco-dna-spaces-tenant-id` with your own Cisco tenant ID.
1. In your view controller displaying the Map View using `MPMapControl`, call `mapControl.showUserPosition(true)`.
1. Build and run the application. You should now be able to show a blue dot for the user's position.
