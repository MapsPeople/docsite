...
1. Make sure you have [integrated MapsIndoors](getting-started/ios) succesfully.
1. Download or clone [this Swift file](https://github.com/MapsPeople/MapsIndoorsSDK-iOS-Examples/blob/main/MapsIndoorsSDK-iOS-Examples/Advanced/Position%20Provider/CiscoDNA/PureCiscoDNAProvider.swift) containing the CiscoDNA integration source.
1. Create a group in your Xcode project, e.g. called CiscoDNA.
