...
We recommend reading [Show the Blue Dot with MapsIndoors](/blue-dot/) guides to get a basic understanding of the MapsIndoors positioning provider interface.
