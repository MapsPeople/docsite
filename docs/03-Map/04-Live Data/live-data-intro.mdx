...
To learn more, visit the [Live Data tutorial for iOS](/live-data-intro/) and the [reference guide](https://app.mapsindoors.com/mapsindoors/reference/ios/v3/interface_m_p_live_data_manager.html).

</TabItem>

<TabItem value="iosv4" label="iOS v4">
...
### Enable Live Data through MPMapControl in iOS (v4 SDK)
...
To learn more, visit the [Live Data tutorial for iOS](/live-data-intro/) and the [reference guide](https://app.mapsindoors.com/mapsindoors/reference/ios/v4-doc/documentation/mapsindoors/mpliveupdate).
