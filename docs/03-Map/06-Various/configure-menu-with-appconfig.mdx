...
//Keep an array of the catagories inside the menuInfo property. This will be usefull for the UIStoryboardSegue.
...
```swift
  override func viewDidLoad() {
        ...
        Task {
            ...
            if let datax = data?.menuInfo {
                for (_, value) in datax {
