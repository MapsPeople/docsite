...
To read more about connected features, check out our documentation on [Display Rules](map/map-styling/display-rules), and how to utilize [2D Models](https://docs-beta.mapsindoors.com/content/cms/#2d-models-and-icons).
