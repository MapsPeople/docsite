...
<img src="/img/cms/media-library-access.png" alt="A screenshot of way to access the Media Library" width="1200"/>

## Interface Overview

<img src="/img/cms/media-library-overview.png" alt="A screenshot of the overview of the Media Library" width="900"/>
...
<img src="/img/cms/media-library.png" alt="A screenshot of the Media Library" width="900"/>
...
<img src="/img/cms/media-library-sort.png" alt="A screenshot of the Media Library sort function" width="600"/>
...
<img src="/img/cms/media-library-filter-filetype.png" alt="A screenshot of the Media Library filter function" width="600"/>
...
<img src="/img/cms/media-library-filter.png" alt="A screenshot of the Media Library filter function" width="600"/>
...
<img src="/img/cms/media-library-sync.png" alt="A screenshot of the Media Library sync function" width="450"/>
...
To read more about connected features, check out our documentation on [Display Rules](map/map-styling/display-rules.md), and how to utilize [2D Models](https://docs-beta.mapsindoors.com/content/cms/#2d-models-and-icons).
