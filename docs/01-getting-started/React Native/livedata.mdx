...
Using the demo API key you should now be able to see a "Staff Person" moving from one end to the other at ground floor in The White House main building.<br/>

Expected result:

<img src="/img/getting-started/react_native_live_data.gif" alt="An animation showing the desired behaviour of this tutorial" width="350"/>
