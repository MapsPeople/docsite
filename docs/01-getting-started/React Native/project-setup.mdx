...
You can find the basic example to start from here: [Basic example](https://github.com/MapsPeople/getting-started-react-native-basic)
...
<Tabs groupId="getting-started-react-native-project-setup-basic">
...
<TabItem value="Manual setup" label="Manual setup" default>
