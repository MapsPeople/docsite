...
See the full example of the search method here: [main.dart]() //MADHTODO

## Filter Locations on Map Based on Search Results

When getting a search result, you might want to only show those search results on the map. You can do this through [calling `setFilterWithLocations(List<MPLocation> locations, MPFilterBehavior behavior)` on `MapsIndoorsWidget`](). This method has different parameters to make it easier for you as a developer to fit your exact need in terms of animation and more.
