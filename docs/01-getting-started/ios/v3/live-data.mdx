...
sidebar_position: 6
slug: /getting-started/ios/live-data
---
...
<img src="/img/getting-started/ios_live-data.gif" alt="An animation showing the desired behaviour of this tutorial" width="350"/>

Learn more about about controlling and rendering Live Data in MapsIndoors in the [introducion to Live Data](/live-data-intro/)
