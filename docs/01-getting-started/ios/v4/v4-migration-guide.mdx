...
let appConfig = MPMapsIndoors.shared.appData()
```
...
DirectionsService & DirectionsRenderer[​](https://docsite.mapsindoors.com/getting-started/android/v4/#directionsservice--directionsrenderer)
-------------------------------------------------------------------------------------------------------------------------------------------------------------
