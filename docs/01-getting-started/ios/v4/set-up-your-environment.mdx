...
* [Google Maps iOS SDK](https://developers.google.com/maps/documentation/ios-sdk/overview): [manual install](https://developers.google.com/maps/documentation/ios-sdk/start#install-manually).
    * You must use [Google Maps iOS version 7.4.0](https://dl.google.com/geosdk/12cdf90d54d85bfcc90d340148d86362ee3189ea24b4bd20ca891e9bd33ded21/GoogleMaps-7.4.0.tar.gz) since MapsIndoors v4 is linked against this version.
...
* Drag and drop the XCFrameworks into your Xcode project. In the dialog that pops up, choose "Copy items if needed" and make sure the XCFrameworks are added to the correct target.
