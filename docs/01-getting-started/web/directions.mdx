...
<head>
  ...
  <script src="https://app.mapsindoors.com/mapsindoors/js/sdk/4.21.3/mapsindoors-4.21.3.js.gz?apikey=d876ff0e60bb430b8fabb145"></script>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>MapsIndoors</title>
  <script src="https://app.mapsindoors.com/mapsindoors/js/sdk/4.21.3/mapsindoors-4.21.3.js.gz?apikey=YOUR_MAPSINDOORS_API_KEY"></script>
