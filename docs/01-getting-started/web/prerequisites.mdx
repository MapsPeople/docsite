...
MapsIndoors is built on top of an external map provider, and on this page, you'll create a an Access Token for your chosen map provider with the relevant APIs enabled, retrieve a MapsIndoors API key and install the necessary dependencies to get started building your own app.
