...
If you need more customisation you can implementing your own solution using the documentation found [here](map/), or modify this code as needed.
...
* Copy the `google_maps_api.xml` file to your project and insert a valid Google Maps API key - [See more info on how to do that here.](getting-started/android/prerequisites/)
...
<img src="/img/getting-started/Android_Single_Page_App.png" alt="Android Single Page App" width="500"/>

## Summary

Congratulations! You now have a functioning map in your own app, with the ability to both search for Locations and generate directions! If you want more advanced features, check out [further documentation](/map/), or modify the existing code from this tutorial to suit your needs!
