...
* **DisplayTypeId**
    ...
    Is a reference to the display type as described below. All room, area and poi geodata requires this to be set. As this is an ID, the reference is a 24 character string format as described above.
