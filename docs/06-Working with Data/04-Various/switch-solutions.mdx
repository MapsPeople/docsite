...
```swift
func setupMapsIndoors(mapsIndoorsAPIKey: String, mapboxAPIKey: String) async throws {
...
func switchSolution() {
    ...
    // Setup MapsIndoors anew
    setupMapsIndoors(mapsIndoorsAPIKey: "YOUR_SECONDARY_API_KEY", mapboxAPIKey: "YOUR_MAPBOX_API_KEY")
}
```
