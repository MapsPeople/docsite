...
|`bearing`|`bearing`|`number`|The bearing (Mapbox) or heading (Google) of the map. |
...
16. `pitch` - Used like this `pitch=30`. Not compatible with MapsIndoors 2d models with Google Maps.
