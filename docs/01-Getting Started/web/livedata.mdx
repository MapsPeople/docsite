...
<Tabs groupId="getting-started-web-livedata">
...
<iframe width="100%" height="600" src="//jsfiddle.net/mapspeople/9e3o1un4/embedded/js,html,result/" frameborder="0"></iframe>

</TabItem>
<TabItem value="gm-components" label="Google Maps - MI Components">

<iframe width="100%" height="600" src="//jsfiddle.net/mapspeople/gzc1uamo/embedded/js,html,result/" frameborder="0"></iframe>

</TabItem>
<TabItem value="mapbox-manual" label="Mapbox - Manually" default>

<iframe width="100%" height="600" src="//jsfiddle.net/mapspeople/7Luf93yo/embedded/js,html/" frameborder="0"></iframe>

</TabItem>
<TabItem value="mapbox-components" label="Mapbox - MI Components">

<iframe width="100%" height="600" src="//jsfiddle.net/mapspeople/Lr70ngoh/embedded/js,html/" frameborder="0"></iframe>
