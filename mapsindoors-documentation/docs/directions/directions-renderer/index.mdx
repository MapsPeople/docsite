...
When getting the resulting Route from a [Directions Service](/directions/directions-service/directions-service/), you may want to display this Route on a map. To perform this task the `MPDirectionsRenderer` can be used.
