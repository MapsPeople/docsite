...
To learn more, visit the [Live Data tutorial for iOS](/map/live-data/live-data-intro/) and the [reference guide](https://app.mapsindoors.com/mapsindoors/reference/ios/v3/interface_m_p_live_data_manager.html).
