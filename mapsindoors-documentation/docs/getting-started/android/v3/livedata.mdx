...
<Tabs groupId="getting-started-android-v3-livedata">
...
Learn more about controlling and rendering Live Data in MapsIndoors in the [introduction to Live Data](/map/live-data/live-data-intro/).
