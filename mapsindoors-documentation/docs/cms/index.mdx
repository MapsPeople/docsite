...
View the tutorial video below for more information about terminology and hierarchy, or visit the [Glossary](/various/glossary/).
...
1. "Edit Display Rules" - The ability to modify the Display Rules for a given Type. Read more about [Display Rules](/various/display-rules/).
